...
namespace EJ0008
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            textBox1.Text += "E3 Nombre: " + E3.Nombre + " -  El nombre del Jefe de E3: " + E3.Jefe.Nombre +
                             Environment.NewLine + Environment.NewLine;
            textBox1.Text += "Observar a continuación lo que ocurrió. El nombre de E2 se ha conservado al igual " +
                             "el nombre del jefe de E2." + Environment.NewLine + Environment.NewLine;
            textBox1.Text += "E2 Nombre: " + E2.Nombre + " -  El nombre del Jefe de E2: " + E2.Jefe.Nombre +
                            Environment.NewLine + Environment.NewLine;
            textBox1.Text += "Esto es debido a la implementación de la clonación profunda. " + Environment.NewLine;
        }
